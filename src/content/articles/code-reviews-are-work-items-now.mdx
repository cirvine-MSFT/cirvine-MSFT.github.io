...
You don't need fancy tooling. [Mermaid](https://mermaid.js.org/) renders right inside a GitHub PR from a fenced code block — you commit a handful of lines of text and your reviewers see a diagram:
